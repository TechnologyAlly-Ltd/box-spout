...
```php
use TA\Spout\Reader\Common\Creator\ReaderEntityFactory; // namespace is no longer "TA\Spout\Reader"
...
...
```php
use TA\Spout\Writer\Common\Creator\WriterEntityFactory; // namespace is no longer "TA\Spout\Writer"
...
...
For the builder, please update your import statements to use the following namespaces:
    ...
    TA\Spout\Writer\Common\Creator\Style\StyleBuilder
    TA\Spout\Writer\Common\Creator\Style\BorderBuilder
...
If your are using these classes directly via an import statement in your code, please use the following namespaces:
    ...
    TA\Spout\Common\Entity\Style\Border
    TA\Spout\Common\Entity\Style\BorderPart
    TA\Spout\Common\Entity\Style\Color
    TA\Spout\Common\Entity\Style\Style
