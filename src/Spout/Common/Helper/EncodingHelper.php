...
use TA\Spout\Common\Exception\EncodingConversionException;
...
class EncodingHelper
{
    ...
    /**
     * @param \TA\Spout\Common\Helper\GlobalFunctionsHelper $globalFunctionsHelper
     */
     ...
     * @throws \TA\Spout\Common\Exception\EncodingConversionException If conversion is not supported or if the conversion failed
