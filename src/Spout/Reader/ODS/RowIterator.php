...
use TA\Spout\Reader\Exception\IteratorNotRewindableException;
...
class RowIterator implements IteratorInterface
{
     ...
     *
     * @throws \TA\Spout\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     * @return void
     */
    ...
    /**
     * @param \TA\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-row>" starting node
    ...
    /**
     * @param \TA\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
