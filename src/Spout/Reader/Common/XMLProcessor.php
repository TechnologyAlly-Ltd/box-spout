...
namespace TA\Spout\Reader\Common;
...
class XMLProcessor
{
    ...
    /**
     * @param \TA\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object
     */
     ...
     *
     * @throws \TA\Spout\Reader\Exception\XMLProcessingException
     * @return void
     */
