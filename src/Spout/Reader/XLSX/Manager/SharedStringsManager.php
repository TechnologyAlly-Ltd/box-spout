...
use TA\Spout\Reader\XLSX\Manager\SharedStringsCaching\CachingStrategyInterface;
...
class SharedStringsManager
{
     ...
     *
     * @throws \TA\Spout\Common\Exception\IOException If shared strings XML file can't be read
     * @return void
     */
     ...
     *
     * @param \TA\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader instance
     * @throws \TA\Spout\Common\Exception\IOException If sharedStrings.xml is invalid and can't be read
     ...
     *
     * @param \TA\Spout\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on a "<si>" node
     ...
     * @throws \TA\Spout\Reader\Exception\SharedStringNotFoundException If no shared string found for the given index
