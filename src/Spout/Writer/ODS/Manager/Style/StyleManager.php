...
use TA\Spout\Writer\ODS\Helper\BorderHelper;

/**
 * Class StyleManager
 * Manages styles to be applied to a cell
 */
class StyleManager extends \TA\Spout\Writer\Common\Manager\Style\StyleManager
{
    /** @var StyleRegistry */
...
EOD;
     ...
     *
     * @param \TA\Spout\Common\Entity\Style\Style $style
     * @return string
     */
