...
interface WriterInterface
{
     ...
     * @throws \TA\Spout\Common\Exception\IOException If the writer cannot be opened or if the given path is not writable
     ...
     * @throws \TA\Spout\Common\Exception\IOException If the writer cannot be opened
     * @return WriterInterface
     */
     ...
     * @throws \TA\Spout\Writer\Exception\WriterNotOpenedException If the writer has not been opened yet
     * @throws \TA\Spout\Common\Exception\IOException If unable to write data
     * @return WriterInterface
     */
     ...
     * @throws \TA\Spout\Common\Exception\InvalidArgumentException If the input param is not valid
     * @throws \TA\Spout\Writer\Exception\WriterNotOpenedException If the writer has not been opened yet
     * @throws \TA\Spout\Common\Exception\IOException If unable to write data
     * @return WriterInterface
     */
