...
namespace TA\Spout\Writer\XLSX\Helper;
...
use TA\Spout\Writer\XLSX\Manager\Style\StyleManager;
 ...
 */
class FileSystemHelper extends \TA\Spout\Common\Helper\FileSystemHelper implements FileSystemWithRootFolderHelperInterface
{
    ...
    /** @var \TA\Spout\Common\Helper\Escaper\XLSX Used to escape XML data */
    private $escaper;
     ...
     * @param \TA\Spout\Common\Helper\Escaper\XLSX $escaper Used to escape XML data
     */
     ...
     *
     * @throws \TA\Spout\Common\Exception\IOException If unable to create at least one of the base folders
     * @return void
     */
     ...
     *
     * @throws \TA\Spout\Common\Exception\IOException If unable to create the folder
     ...
     *
     * @throws \TA\Spout\Common\Exception\IOException If unable to create the folder or the ".rels" file
     * @return FileSystemHelper
     */
     ...
     *
     * @throws \TA\Spout\Common\Exception\IOException If unable to create the file
     * @return FileSystemHelper
     */
...
EOD;
     ...
     *
     * @throws \TA\Spout\Common\Exception\IOException If unable to create the folder or one of the files
     * @return FileSystemHelper
     */
...
EOD;
     ...
     *
     * @throws \TA\Spout\Common\Exception\IOException If unable to create at least one of the folders
     * @return FileSystemHelper
     */
