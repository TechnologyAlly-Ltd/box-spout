...
use TA\Spout\Reader\CSV\Creator\InternalEntityFactory;
use TA\Spout\Reader\CSV\Manager\OptionsManager;
use TA\Spout\Reader\Exception\ReaderNotOpenedException;
...
class ReaderTest extends TestCase
{
    ...
    public function testOpenShouldThrowExceptionIfFileNotReadable()
    {
        ...
        /** @var \TA\Spout\Common\Helper\GlobalFunctionsHelper|\PHPUnit\Framework\MockObject\MockObject $helperStub */
        $helperStub = $this->getMockBuilder('\TA\Spout\Common\Helper\GlobalFunctionsHelper')
    ...
    public function testReadShouldSupportNonUTF8FilesWithoutBOMs($fileName, $fileEncoding, $shouldUseIconv)
    {
        ...
        /** @var \TA\Spout\Reader\CSV\Reader $reader */
        $reader = $this->createCSVReader(null, $helperStub);
        $reader
    ...
    /**
     * @param \TA\Spout\Common\Helper\GlobalFunctionsHelper|null $optionsManager
     * @param \TA\Spout\Common\Manager\OptionsManagerInterface|null $globalFunctionsHelper
